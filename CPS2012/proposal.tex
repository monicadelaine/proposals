...
\fancyhead[CO,CE]{\textit{\textcolor{light-gray}{\small CPS: Breakthrough: Using domain specific languages to communicate syntax and semantics of device interfaces to enable discovery and change notification}}}
